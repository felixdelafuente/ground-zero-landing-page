  ...
  services: [
    {
      ...
      description: `Engage employees in friendly competitions and challenges that promote physical activity and boost motivation. These challenges can include step challenges, weight loss challenges, or team-based fitness competitions.`,
      image: Images.CarouselSlide1,
    },
    {
      title: `WELLNESS WORKSHOPS`,
      description: `Conduct educational workshops on topics such as stress management, nutrition, mindfulness, and work-life balance. These workshops provide valuable insights and practical strategies for employees to enhance their overall well-being.`,
      image: Images.CarouselSlide2,
    },
    {
      title: `GROUP EXERCISE CLASSES`,
      description: `Offer a variety of fitness classes tailored to different fitness levels and preferences. Options can include yoga, pilates, Zumba, HIIT (high-intensity interval training), and strength training. These classes promote physical fitness and create a sense of community among employees.`,
      image: Images.CarouselSlide3,
    },
    {
      title: `SPORTS LEAGUES AND TOURNAMENTS`,
      description: `Organize sports leagues and tournaments that allow employees to participate in friendly competitions. Popular options include football (soccer), basketball, volleyball, and cricket. These activities promote teamwork, camaraderie, and a healthy competitive spirit.`,
      image: Images.CarouselSlide4,
    },
    {
      title: `WELLNESS CHALLENGES AND INCENTIVE PROGRAMS`,
      description: `Implement wellness challenges and incentive programs to encourage employees to adopt healthy habits. These programs can include tracking steps, achieving fitness goals, or practicing mindfulness. Rewarding participants with incentives further motivates them to prioritize their well-being.`,
      image: Images.CarouselSlide5,
    },
    {
      title: `ON-SITE WELLNESS EVENTS`,
      description: `Host on-site wellness events such as health fairs, wellness expos, and health screenings. These events provide employees with access to valuable resources, information, and services related to their health and well-being.`,
      image: Images.CarouselSlide6,
    },
    {
      title: `PERSONALIZED TRAINING PLANS`,
      description: `Offer personalized training plans tailored to individual employee needs and goals. These plans can include fitness assessments, one-on-one coaching sessions, and customized workout routines to help employees achieve their desired fitness levels.`,
...
export const Testimonials = {
  testimonials: [
    {
      image1: Images.RhoxineValenzuela,
      person1: `Rhoxine Valenzuela-Magtagnob`,
      title1: `Business Owner, Shokudo Connect Restaurant`,
      statement1: `Ground Zero is a reliable and committed merchant partner, bringing detailed agreements and sharing ideas for business progression in health, wellness, and fitness. They prioritize commitment, integrity, and leaving a lasting legacy.`,
      image2: Images.JoshreyVasquez,
      person2: `Joshrey Vasquez`,
      title2: `Student, Legends Basketball Program`,
      statement2: `What's good? What's good about the program is the intensive training What's not good? Not gonna lie there's nothing wrong with the program it's all good`,
    },
    {
      image1: Images.FrancisLavarias,
      person1: `Francis Lavarias`,
      title1: `Parent, Legends Basketball Program`,
      statement1: `Than you very much to Ground Zero for their commitment and excellent training services to my son’s basketball skills. Kudos to coach Carl for making it as a fun and at the same time engaging experience.`,
      image2: Images.AarenSalvador,
      person2: `AAREN SALVADOR`,
      title2: `Student, Legends Basketball Program`,
      statement2: `The Ground Zero Legends Program is a top-notch basketball academy that improves shooting skills and provides excellent support during practices and games, led by Coach Labueno Casas and Coach Carl Romero.`,
    },
    {
      image1: Images.NobertoJr,
      person1: `Norberto Jr.`,
      title1: `Parent, Legends Basketball Program`,
      statement1: `Ground Zero's program, led by Coach Carl and Coach Lab, has successfully improved my son's basketball skills, offering knowledgeable guidance and excellent support. Their responsiveness and ease of interaction make them highly recommended for anyone seeking to enhance their game.`,
      image2: Images.NathanielFaustino,
      person2: `Nathaniel Faustino`,
      title2: `Student, Legends Basketball Program`,
